...
| Offizielle MI3DOR-Metriken (Benchmark-Definitionen: ST@2C-1, F mikro@20, DCG mit Off-by-one-Diskont ueber C, ANMRR mit S=min(4C,2*T_max) + Positions-Logik, AUC) | `stage2/metrics_official.csv` + `stage2/metrics_official_manifest.json` (Pfad A: 4 gewichtete Arme, partial; Waechter NN/FT exakt auf Produktion) | Port `object_retrieval/mi3dor_official_metrics.py` von cross_performance.m (Commit 4325c24c, 2023-10-24) auf `channel_scores.npz` |
