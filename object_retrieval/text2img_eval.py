...
with open("../object_database/ycbv_gso/blip_descriptions.json", "r") as f:
...
# Save results to CSV
def save_results_to_csv(results, bop_data_root):
    save_path = os.path.join(bop_data_root, "results", "evaluation_result.csv")
...
if __name__ == "__main__":
    ...
    save_results_to_csv(results,bop_data_root )
